...
function display_dashboard_widget()
{
  ...
  // setup the content with a list 
	$widget_content =  '<h4>Maybe Do Something Here</h4>';
	$widget_content .= '<ol>
	<li>List of stuff</li> 
	</ol>'; 
	$widget_content .= '<hr />';
	$widget_content .=  '<h4>Grants Detailed Instructions</h4>';
  $widget_content .= '<ul>';
...
{  
	if ( current_user_can( 'edit_posts' ) ) {
	  ...
	  wp_add_dashboard_widget('private_page_menu_dashboard_widget', 'Daniel Stuff', 'display_dashboard_widget' ); 
	}
}
